...
nome, tentativas_binaria = pesquisa_binaria(lista, numero)

tentativas_sequencial = 0

for valor, nome_sequencial in lista:
...
print("Nome associado ao número", numero, ":", nome)
print("Tentativas na pesquisa binária:", tentativas_binaria)
print("Tentativas na pesquisa sequencial:", tentativas_sequencial)
